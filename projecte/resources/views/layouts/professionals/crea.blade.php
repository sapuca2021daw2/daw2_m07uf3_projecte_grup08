    ...
    @if($ong)
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-8">
                    <div class="card">
                        <div class="card-header">{{ __('Nou Professional') }}</div>
                            ...
                            <form method="POST" action="{{route('professional.store')}}">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col">
                                        ...
                                        <div class="form-group row">
                                            <label for="carrec"
                                                    class="col-md-4 col-form-label text-md-right">{{ __('Càrrec') }}</label>
                                            <div class="col-md-6">
                                                <input id="carrec" type="text"
                                                        class="form-control"
                                                        name="carrec"
                                                        value="{{ old('carrec') }}" required autocomplete="carrec"
                                                        autofocus>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6">
                                                <input pattern="[0-9]+" id="seguretatSocial" type="text"
                                                        class="form-control"
                                                        name="seguretatSocial"
                                                        value="{{ old('seguretatSocial') }}" required autocomplete="seguretatSocial"
                                                        autofocus>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6">
                                                <input pattern="([0-9]|[0-9][0-9]|100)" minlength="1" maxlength="3" id="percentatgeIRPF" type="text"
                                                        class="form-control"
                                                        name="percentatgeIRPF"
                                                        value="{{ old('percentatgeIRPF') }}" required autocomplete="percentatgeIRPF"
                                                        autofocus>
                                            </div>
                                        </div>
                                    </div>
